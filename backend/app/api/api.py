...
from app.api.v1.endpoints import auth, student, subjects, timetable, attendance, quiz, calendar, events, laboratory, dashboard, analytics, feedback, preferences, notifications, admin
