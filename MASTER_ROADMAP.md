...
> cross-slot + elective×regular rejected; baseline restored). CRUD API and
> frontend (24.7-C) NOT STARTED — require operator review and fresh execution
> prompts. 24.8+ NOT STARTED.
...
Phase 24.7-C — HTTP CRUD API layer: admin timetable endpoints (list/detail/create/update/deactivate) wired over `AdminTimetableService`, `require_any_admin`/`require_head_admin` gates, domain-error → HTTP mapping, and frontend timetable editor (24.7-D). NOT STARTED.
