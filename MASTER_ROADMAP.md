...
> locally); regressions 24.3 40/40 + 24.5 46/46 + 24.6 46/46. 24.7-B (CRUD
> API) and beyond NOT STARTED — require operator review and fresh execution
...
Phase 24.7-B — CRUD API (list/create/update/patch timetable entries via the admin endpoint, service-layer validation, and conflict detection). NOT STARTED.
