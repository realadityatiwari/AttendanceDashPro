...
export function NotificationBell({ onOpenModal }: NotificationBellProps) {
  ...
  return (
    <button
      ...
      onClick={handleOpen}
      className="relative -m-1.5 flex items-center rounded-md p-2.5 text-muted-foreground outline-none transition-colors hover:bg-muted/60 hover:text-foreground focus-visible:bg-muted/60 focus-visible:ring-2 focus-visible:ring-ring/60 sm:-m-1.5 sm:p-2"
    >
